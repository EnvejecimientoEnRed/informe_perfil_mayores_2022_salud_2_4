...
function setChartHeight(iframe) {
    if(iframe == 'fixed') {
        ...
        document.getElementsByClassName('container')[0].style.height = '620px';
        document.getElementsByClassName('main')[0].style.height = '592px';
        ...
        let height = 592; //Altura total del main
